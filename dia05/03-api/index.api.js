...
/*
 ...
 -D ou --save-dev salva a dependencia somente para o desenvolvimento

 npm i -D nodemon

 vamos adicionar scripts automatizados em nosso package.json 
 npm -> ele executa comandos usando a node_modules
 "start": npx nodemon index.api.js
 para executar 
 npm start
 caso o comando for qualquer outro nome 
 "desenvolvimento" : "ola mundo"
 npm run desenvolvimento -> usamos o RUN para comandos custumizados 
